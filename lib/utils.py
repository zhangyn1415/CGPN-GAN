...
def choose_model(model):
    ...
    NetG, NetD, NetC, CLIP_IMG_ENCODER, CLIP_TXT_ENCODER, patchD = model.NetG, model.NetD, model.NetC, model.CLIP_IMG_ENCODER, model.CLIP_TXT_ENCODER, model.MultiscaleDiscriminator
    return NetG,NetD,NetC,CLIP_IMG_ENCODER, CLIP_TXT_ENCODER,patchD
